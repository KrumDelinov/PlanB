...
namespace PlanB.Data.Migrations
{
    ...
    [Migration("20220207134231_NewBatchEntity")]
    partial class NewBatchEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlanB.Data.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("PlanB.Data.Models.Batch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("PlanB.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PlanB.Data.Models.ApplicationUser", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("PlanB.Data.Models.Batch", b =>
                {
                    b.HasOne("PlanB.Data.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
